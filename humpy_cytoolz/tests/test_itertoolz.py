...
from humpy_cytoolz.itertoolz import (
...
def test_merge_sorted():
    ...
    data = [[(1, 2), (0, 4), (3, 6)], [(5, 3), (6, 5), (8, 8)], [(9, 1), (9, 8), (9, 9)]]
...
def test_join():
    ...
    expected = {(1, 'one', 'apple', 1), (1, 'one', 'orange', 1), (2, 'two', 'banana', 2), (2, 'two', 'coconut', 2)}
...
def test_outer_join():
    result = set(join(identity, [1, 2], identity, [2, 3], left_default=None, right_default=None))
...
def test_diff():
    ...
    data1 = [{'cost': 1, 'currency': 'dollar'}, {'cost': 2, 'currency': 'dollar'}]
    data2 = [{'cost': 100, 'currency': 'yen'}, {'cost': 300, 'currency': 'yen'}]
