...
of `humpy_cytoolz` and may be skipped.  These tests are only run if the
...
if do_toolz_tests:
    do_toolz_tests = humpy_toolz.__version__.startswith(humpy_cytoolz.__toolz_version__)
    do_toolz_tests &= '+' not in humpy_cytoolz.__version__
